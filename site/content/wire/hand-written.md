...
:::warning
This document is best consumed and actioned by LLM coding agents.
It can be finicky to do so by hand, as mis-matches can be subtle, despite our best efforts.
:::
