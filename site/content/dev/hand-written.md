...
description: Sources and update procedures for manually maintained compiler facts.
order: 4
---

<p class="xantham-lead">Use this register during compiler updates to check the facts maintained by hand and the upstream sources they come from.</p>
...
`tsc closed the pipe mid-frame` with the real message on stderr. A failed callback is equally
