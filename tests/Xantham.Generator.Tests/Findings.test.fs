          ...
          testCase "the key table is append-only" <| fun _ ->
              ...
              let expected =
                  [ "TR001 TypeReference.SelfReferenceThroughUnnamed widened"
                    ...
                    "TP009 TypeParameters.DuplicateTypeParameterCollapsed ergonomic"
                    ...
                    "HG004 HarvestGlobals.AmbientModuleHarvested exact"
                    "HG005 HarvestGlobals.AmbientModuleWildcard escape"
                    "HG006 HarvestGlobals.NamespaceIsModuleBody exact"
                    ...
                    "SY003 SynthesizeAnonymous.IntersectionOperandNotHoisted widened"
                    ...
                    "SA003 ShapeAliases.AbbreviationNameTaken widened"
