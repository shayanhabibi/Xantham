          ...
          testCase "the key table is append-only" <| fun _ ->
              ...
              let expected =
                  [ "TR001 TypeReference.SelfReferenceThroughUnnamed widened"
                    ...
                    "TR037 TypeReference.ArgumentNotASubtypeOfConstraint widened"
                    ...
                    "SI004 ShapeInterfaces.BaseInherited exact"
                    "SI005 ShapeInterfaces.BaseNotDeclaredHere ergonomic"
                    "SI006 ShapeInterfaces.BaseWouldCycle ergonomic"
