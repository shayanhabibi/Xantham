...
<Project Sdk="Microsoft.NET.Sdk">
    ...
    <ItemGroup>
        ...
        <PackageReference Include="Xantham.Fable.Core.TS" Version="0.1.0-alpha.3" />
    </ItemGroup>
...
- **`Xantham.Fable.Core.TS`.** Generated consumer files open `Fable.Core.TS.Dom`.
  DOM references use this package's bindings, generated from the same pinned TypeScript
  declarations. The compiler-library producer itself omits that open to avoid a self dependency.
