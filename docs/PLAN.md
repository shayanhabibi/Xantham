...
**Phase-1 finding (2026-07-02): the opaque-handle policy is now quantified.** Zod owns 14,574 keys — **47% of the entire IR** — versus Workers' 5,425. The manifest's avoidance axis (zod as policy-holder, never fully emitted) keeps nearly half the crawled type program out of the shipped surface; the measured decomposition replaces the old inference from error counts.
