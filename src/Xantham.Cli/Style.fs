...
let private startColour =
    { R = 0x00; G = 0x78; B = 0xE0 } // #0078E0

let private endColour =
    { R = 0xA0; G = 0x7E; B = 0xE8 } // #A07EE8
...
let private markup =
    ...
    let builder =
        StringBuilder(wordmark.Length * width * 20)
...
let renderFiglet useColor =
    if useColor
    then AnsiConsole.Write(markup)
    else AnsiConsole.Write(figlet)