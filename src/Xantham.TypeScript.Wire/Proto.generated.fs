...
module rec Proto =
    ...
    type BatchRequestsParams = {
        ...
        [<JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)>]
        ContinuationToken: string voption

        [<JsonPropertyName "maxResponseBytesPerPage">]
        [<JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)>]
        MaxResponseBytesPerPage: int voption
    } with

        static member val private DefaultValue = lazy ({
            Requests = ValueNone
            ContinuationToken = ValueNone
            MaxResponseBytesPerPage = ValueNone
        }: BatchRequestsParams)
        ...
        /// `{ BatchRequestsParams.Default with ... }` - rather than writing all 3 out.
    ...
    type UpdateSnapshotParams = {
        ...
        [<JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)>]
        FileSystem: RequestFileSystem voption
        ...
        /// The record with nothing set: every field is either optional or a default of its
        /// own, so this serialises to `{}`. Copy-update it to fill in the fields you mean -
        /// `{ UpdateSnapshotParams.Default with ... }` - rather than writing all 7 out.
    ...
    type TypeResponse = {
        ...
        [<JsonPropertyName "labeledElementDeclarations">]
        [<JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)>]
        LabeledElementDeclarations: string[] voption
    ...
    type ResolvedModule = {
        ...
        [<JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)>]
        OriginalPath: string voption

        [<JsonPropertyName "extension">]
        Extension: string

        [<JsonPropertyName "resolvedUsingTsExtension">]
        [<JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)>]
        ResolvedUsingTsExtension: bool voption

        [<JsonPropertyName "resolvedUsingExtraExtensions">]
        [<JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)>]
        ResolvedUsingExtraExtensions: bool voption

        [<JsonPropertyName "packageId">]
        [<JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)>]
        PackageId: PackageId voption

        [<JsonPropertyName "isExternalLibraryImport">]
        [<JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)>]
        IsExternalLibraryImport: bool voption

        [<JsonPropertyName "alternateResult">]
        [<JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)>]
        AlternateResult: string voption
    }

    type GetResolvedModuleFromModuleSpecifierParams = {
        [<JsonPropertyName "snapshot">]
        Snapshot: int
        ...
        [<JsonPropertyName "moduleSpecifier">]
        ModuleSpecifier: string

        [<JsonPropertyName "sourceFile">]
        [<JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)>]
        SourceFile: DocumentIdentifier voption
    }

    type GetResolvedTypeReferenceDirectiveParams = {
        [<JsonPropertyName "snapshot">]
        Snapshot: int
        ...
        [<JsonPropertyName "typeDirectiveName">]
    ...
    type GetResolvedTypeReferenceDirectiveFromReferenceParams = {
        [<JsonPropertyName "snapshot">]
        Snapshot: int
    ...
    type EmitResponse = {
        ...
        /// EmittedFilesContents contains contents parallel to EmittedFiles when the
        /// source snapshot uses a full filesystem. It is empty for write-through emits.
        [<JsonPropertyName "emittedFilesContents">]
    ...
    module Method =
        ...
        /// `GetResolvedModuleParams` -> `ResolvedModule voption`
        [<Literal>]
        let GetResolvedModule = "getResolvedModule"

        /// `GetResolvedModuleFromModuleSpecifierParams` -> `ResolvedModule voption`
        [<Literal>]
        let GetResolvedModuleFromModuleSpecifier = "getResolvedModuleFromModuleSpecifier"

        /// `GetResolvedTypeReferenceDirectiveParams` -> `ResolvedTypeReferenceDirective voption`
        [<Literal>]
        let GetResolvedTypeReferenceDirective = "getResolvedTypeReferenceDirective"

        /// `GetResolvedTypeReferenceDirectiveFromReferenceParams` -> `ResolvedTypeReferenceDirective voption`
        [<Literal>]
        let GetResolvedTypeReferenceDirectiveFromTypeReferenceDirective = "getResolvedTypeReferenceDirectiveFromTypeReferenceDirective"
