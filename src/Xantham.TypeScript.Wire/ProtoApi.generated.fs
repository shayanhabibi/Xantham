...
module Api =
    ...
    let getResolvedModule (channel: TscChannel) (parameters: GetResolvedModuleParams) : ResolvedModule voption =
        ProtoJson.requestOption<GetResolvedModuleParams, ResolvedModule> channel Method.GetResolvedModule parameters

    let getResolvedModuleFromModuleSpecifier (channel: TscChannel) (parameters: GetResolvedModuleFromModuleSpecifierParams) : ResolvedModule voption =
        ProtoJson.requestOption<GetResolvedModuleFromModuleSpecifierParams, ResolvedModule> channel Method.GetResolvedModuleFromModuleSpecifier parameters

    let getResolvedTypeReferenceDirective (channel: TscChannel) (parameters: GetResolvedTypeReferenceDirectiveParams) : ResolvedTypeReferenceDirective voption =
        ProtoJson.requestOption<GetResolvedTypeReferenceDirectiveParams, ResolvedTypeReferenceDirective> channel Method.GetResolvedTypeReferenceDirective parameters

    let getResolvedTypeReferenceDirectiveFromTypeReferenceDirective (channel: TscChannel) (parameters: GetResolvedTypeReferenceDirectiveFromReferenceParams) : ResolvedTypeReferenceDirective voption =
        ProtoJson.requestOption<GetResolvedTypeReferenceDirectiveFromReferenceParams, ResolvedTypeReferenceDirective> channel Method.GetResolvedTypeReferenceDirectiveFromTypeReferenceDirective parameters
...
module TscChannelExtensions =
    ...
    type TscChannel with
        ...
        member inline this.batchRequests([<Struct>] ?requests: BatchRequest[], [<Struct>] ?continuationToken: string, [<Struct>] ?maxResponseBytesPerPage: int) =
            this.batchRequests(
                { Requests = requests
        ...
        member this.getResolvedModule(parameters: GetResolvedModuleParams) = Api.getResolvedModule this parameters
        ...
        member this.getResolvedModuleFromModuleSpecifier(parameters: GetResolvedModuleFromModuleSpecifierParams) = Api.getResolvedModuleFromModuleSpecifier this parameters
        ...
        member this.getResolvedTypeReferenceDirective(parameters: GetResolvedTypeReferenceDirectiveParams) = Api.getResolvedTypeReferenceDirective this parameters
        ...
        member this.getResolvedTypeReferenceDirectiveFromTypeReferenceDirective(parameters: GetResolvedTypeReferenceDirectiveFromReferenceParams) = Api.getResolvedTypeReferenceDirectiveFromTypeReferenceDirective this parameters
